...
@defform[#:literals [coordinates elevation country size radio]
         ...
         #:contracts ([nav-id nav-id/c]
                      ...
                      [airport-size size/c]
                      [channel-name string?]
                      [frequency airport-freq/c])]{
 Defines an airport using the following information commonly found on the
 airport chart. Once defined, the airport can be referenced using its
 @racket[nav-id].

 The following is an example of an airport definition for
